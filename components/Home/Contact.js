...
export default function Contact() {
  ...
  return (
    <div className="mx-auto p-2 lg:w-10/12">
      <div className="mx-auto flex w-full flex-col">
        <h2 className="text-center text-4xl font-medium lg:py-4">
          Connect With Us
        </h2>
      ...
      <div>
        <form
          className="container mx-auto w-11/12 py-8 lg:w-full"
          onSubmit={onSubmit}
        >
          {errors.form && (
          ...
          <div className="flex w-full gap-4 py-6">
            <div className="relative w-full">
              ...
              />
              <label
                className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 text-xl font-normal text-gray-400 duration-300 peer-placeholder-shown:start-6 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-gray-600"
              >
                Name
              </label>
          ...
          <div className="py-4">
            <button
              type="submit"
              className="flex w-6/12 items-center justify-center gap-2 border-2 border-gray-300 px-5 py-2.5 text-center text-xl text-gray-400 hover:bg-gray-800 hover:text-white"
            >
